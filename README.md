# genpark-git-semantic-merge-conflict-resolver-skill
...
> **GenPark AI Agent Skill** -- Semantic Git merge conflict resolver analyzing AST changes across branches (GitKraken style)
